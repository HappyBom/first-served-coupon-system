...
public class RedisRepository {
    ...
    public void issueRequest(long couponId, long userId, int totalCnt){
        ...
        try{
            ...
            throw new CouponIssueException(ErrorCode.FAIL_COUPON_ISSUE_REQUEST, "Data : %s".formatted(couponIssueRequest));
        }
    }
